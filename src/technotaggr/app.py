...
OUTPUT_DIR = Path.cwd() / "technotaggr_results"
...
def get_available_sessions(output_dir: Path = OUTPUT_DIR) -> list[Path]:
...
def get_latest_session(output_dir: Path = OUTPUT_DIR) -> Path | None:
